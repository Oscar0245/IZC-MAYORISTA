...
<body>
  ...
  <section class="hero">
    <div class="hero-banner">
      <div class="hero-text">
        <h1>Consulta los precios de nuestros productos</h1>
        <a class="btn-download" href="assets/files/lista-precios-izc.xlsb" download="Lista de Precios IZC.xlsb">Descargar Lista de precios</a>
      </div>
    </div>
  </section>
